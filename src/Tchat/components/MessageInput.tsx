...
export function MessageInput( props: {isDraggable: boolean, setIsDraggable: React.Dispatch<React.SetStateAction<boolean>>, send: (value: string)=> void}){
    ...
    const selected = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pin-angle" viewBox="0 0 16 16">
    ...
    const select = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pin-angle-fill" viewBox="0 0 16 16">
