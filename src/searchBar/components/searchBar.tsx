...
export default function SearchBar() {
    ...
    const handleResearch = () => {
        const newArticles = allArticles.filter(article => {
            ...
            const isincludeArray = (target: number[], include: number[]) => {//include=selection de l'utilisateur && target=ID de chaques articles
                ...
                include.forEach(item => {//on verifie chaque element de la selection, et on regarde (oui/non) si il se trouve à l'interieur de l'article
            ...
            <div className="row d-flex flex-row justify-content-between align-items-center ">
                ...
                <div className="col-md-2 col-12 mb-2 ">
                    <div className="form-floating ">
                        <input className="form-control form-control-sm" type="text" placeholder="Recherche Rapide" aria-label="search" onChange={event => setInputSearch(event.target.value)} />
                ...
                <div className="col-md-2 col-12 mb-2">
                    <div className="form-floating ">
                        <input type="text" className="form-control form-control-sm " placeholder="Rechercher par Titre" aria-label="search" onChange={event => setInputTitle(event.target.value)} />
                ...
                <div className="col-md-2 col-12 mb-2">
                    <div className="form-floating ">
                        <input type="text" className="form-control " placeholder="Rechercher par Auteur" aria-label="search" onChange={event => setInputAuthor(event.target.value)} />
                        <label htmlFor="floatingInput">Recherche par Auteur</label>
                    </div>
                </div>

                <div className="col-md-2 col-12 mb-2">
                    <DropDown table={TablesEnums.categories} defaultValue={[]}
